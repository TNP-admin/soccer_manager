    ...
    <div class="col-md-12">
      <div class="card card-user">
        <div class="card-header">
          <h5 class="card-title">ユーザー情報変更</h5>
        </div>
        <div class="card-body">
          ...
          <form action="/user_edit" method="post">
            ...
            <div class="row">
              <div class="col-md-3 pr-1">
                <div class="form-group">
                  ...
                  <select type="text" class="form-control" name="club_id">
                    ...
                    <option value="$club->club_id" {{$user->club_id == $club->club_id?"selected":""}}>{{$club->club_name}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              <div class="col-md-2 pr-1">
                <div class="form-group">
                  <label>入学年度</label>
                  <input type="number" class="form-control" name="entrance_year" min="2015" value="{{$user->entrance_year}}">
                </div>
              </div>
              <div class="col-md-2 pr-1">
                <div class="form-group">
              ...
              <div class="col-md-2 pr-1">
                <div class="form-group">
                  ...
                  <select name="position" class="form-control">
                    <option value="0" @if ($user->position == 0) selected @endif>なし</option>
            ...
            <div class="row">
              <div class="col-md-12 pr-1">
                <div class="form-group">
                  <label>備考</label>
                  <input type="text" class="form-control" name="remarks" value="{{$user->remarks}}">
                </div>
              </div>
            </div>
            <div class="row">
