  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="/copy_match" method="post">
            @csrf
            <div class="row">
		  ...
		  <label>フル・前後半</label>
              ...
              <div class="col-md-1 pr-1">
                <div class="form-group">
                  ...
                  <input type="checkbox" id="overtime" name="overtime" value="1" {{$match->overtime == 1 ? 'checked' : ''}}>
                </div>
              </div>
              <div class="col-md-2 pr-1">
                <div class="form-group">
              ...
              <div class="col-md-1 pr-1">
                <div class="form-group">
                  ...
                  <input type="checkbox" id="pk" name="pk" value="1" {{$match->pk == 1 ? 'checked' : ''}}>
                </div>
              </div>
              <div class="col-md-2 pr-1">
                <div class="form-group">
          ...
          <div class="col col-md-1 pr-1 d-flex align-items-center">
            ...
            <div class="row">
              <div class="update ml-auto mr-auto">
                <input type="submit" class="btn btn-primary btn-round" name="submit" value="確定">
              </div>
            </div>
          </form>
        </div>
